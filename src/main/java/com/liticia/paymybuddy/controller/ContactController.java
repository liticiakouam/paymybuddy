...
public class ContactController {
    ...
    @GetMapping("/contact/remove/{user}")
    public String removeUserFromYourFriendList (@PathVariable(value = "user") User user, Model model, RedirectAttributes redirectAttributes) {
